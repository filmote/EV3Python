...
DEBUG_MOVEMENT_ROTATION                     = (1 << 10)
DEBUG_MOVEMENT_ROTATION_STARTING_POSITION   = (1 << 11)
DEBUG_MOVEMENT_ROTATION_CURRENT_POSITION    = (1 << 12)
DEBUG_MOVEMENT_ROTATION_FINAL_POSITION      = (1 << 13)
DEBUG_MOVEMENT_ROTATION_ALL                 = DEBUG_MOVEMENT_ROTATION | DEBUG_MOVEMENT_ROTATION_STARTING_POSITION | DEBUG_MOVEMENT_ROTATION_CURRENT_POSITION | DEBUG_MOVEMENT_ROTATION_FINAL_POSITION
